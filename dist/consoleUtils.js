...
exports.printL = printL;
exports.printE = printE;
exports.dateToStr = dateToStr;
exports.prettySlice = prettySlice;
exports.shieldRegEx = shieldRegEx;
exports.replaceDictionary = replaceDictionary;
exports.wait = wait;
...
function printD(obj, options = { head: true, depth: 0 }) {
    function decorateLines(inputString) {
    ...
    if (options.head && obj && typeof obj === 'object' && !Array.isArray(obj) && Object.keys(obj).length === 1) {
        ...
        ``;
        print(format(String(typeof obj[firstKey]) + ' ' + firstKey, { foreground: 'black', background: 'blue', formatting: ['bold'] }));
        let text = util.inspect(obj[firstKey], { depth: options.depth === 0 ? null : options.depth, colors: true });
        return print(decorateLines(text));
    }
    print(format('ololo', { foreground: 'blue', background: 'blue', formatting: ['bold'] }));
    let text = util.inspect(obj, { depth: options.depth === 0 ? null : options.depth, colors: true });
    return print(decorateLines(text));
}
async function printL(text = "", newLine = true) {
...
function prettySlice(input, minLength, maxLength, breakers = ['\n', '.', ',', ' ']) {
...
function shieldRegEx(str) {
    return str.replace(/[-[\]{}()*+?.,\\^$|#\s%]/g, "\$&");
}
function replaceDictionary(content, dictionary, prefix = '[', postfix = ']') {
